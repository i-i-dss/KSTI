  ...
  ['R','I','O','T'].forEach(axis => {
    ...
    chartHtml += `
      <div class="axis-card" data-axis="${axis}">
        ...
        <div class="axis-bar">
          <div class="segment left" style="width: ${percent}%; background-color: ${axisColors[axis]};"></div>
          <div class="segment right" style="width: ${oppPercent}%; background-color: ${axisColors[opp]};"></div>
        </div>
        <div class="percent-labels">
          <span style="color: ${axisColors[axis]}; font-weight: 700;">${percent}%</span>
          <span style="color: ${axisColors[opp]}; font-weight: 700;">${oppPercent}%</span>
        </div>
      </div>`;
  });
  chartHtml += `
